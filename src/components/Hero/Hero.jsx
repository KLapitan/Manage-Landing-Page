...
return(
<main className=" h-auto max-w-6xl w-full font-Be-Vietnam-Pro   ">
    <section className="p-3 h-auto w-full  flex flex-col gap-3 items-center sm:flex-row-reverse sm:justify-between  md:mt-4 lg:mt-15 ">
        <picture>
