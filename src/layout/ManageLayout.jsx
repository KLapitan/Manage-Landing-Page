...
<div className="relative overflow-x-hidden max-h-auto h-screen w-full ">
...
<Footer/> 
 ...
 {/* largeview left side */}
<div className="absolute z-0 w-190 h-195 hidden sm:block md:-bottom-200 md:-left-100  lg:-bottom-223  lg:-left-113 ">
{/* bandage like pattern   */}
<picture >
<img src="/images/bg-tablet-pattern.svg" alt="pattern-logo" className="w-full h-full"/>
</picture>
