...
{/* larger than mobile */}
  ...
  product teams. </span>
    ...
    <span className=" flex flex-row gap-4 justify-start  w-full items-center rounded-l-full sm:bg-white bg-N-Orange50 lg:gap-11  ">
    <span className=" py-2 px-4 rounded-full bg-P-Orange400  text-N-Graye50 text-xs lg:px-5">0{item.id}</span>
